...
#constants
BUTTON_STATE_SINGLECLICK_WAIT=const(0)
BUTTON_STATE_SINGLECLICK_DEBOUNCING=const(1)
BUTTON_STATE_SINGLECLICK_DEBOUNCED=const(2)
BUTTON_STATE_DOUBLECLICK_WAIT=const(3)
BUTTON_STATE_DOUBLECLICK_WAIT_ENDED=const(4)
BUTTON_STATE_DOUBLECLICK_DEBOUNCING=const(5)
BUTTON_STATE_DOUBLECLICK_DEBOUNCED=const(6)
BUTTON_STATE_REPEAT_WAIT=const(7)
BUTTON_STATE_REPEAT_DEBOUNCING=const(8)
BUTTON_STATE_REPEAT_DEBOUNCED=const(9)
